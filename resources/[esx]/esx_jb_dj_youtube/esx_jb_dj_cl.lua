			...
			trigger = {
				...
				active = {
					callback = function()
						...
						local number =distance/v.dancefloor.Marker.w
						local volume = round(((1-number)/1), 2)
...
function OpenDjMenu()
	local elements = {}
	table.insert(elements, {label = 'Play Musica', value = 'play_music'})
	table.insert(elements, {label = 'Pausar Musica', value = 'pause_music'})
	table.insert(elements, {label = 'Stop Musica', value = 'stop_music'})

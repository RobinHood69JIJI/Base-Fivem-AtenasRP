...
RegisterNetEvent('esx_vehicleshop:setVehicleOwnedATENASPlayerId')
AddEventHandler('esx_vehicleshop:setVehicleOwnedATENASPlayerId', function(playerId, vehicleProps, model, label)
...
ESX.RegisterServerCallback('esx_vehicleshop:buyVehicle', function(source, cb, model, plate)
    ...
    if category == "vip" then
        if modelPrice and xPlayer.getAccount("vip").money >= modelPrice then
            xPlayer.removeAccountMoney("vip", modelPrice)

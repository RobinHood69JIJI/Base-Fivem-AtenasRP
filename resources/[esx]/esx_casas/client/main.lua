...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        if dist <= 500.0 then
            DrawMarker(29, Config.Furnituring['enter'], vector3(0.0, 0.0, 0.0), vector3(0.0, 0.0, 0.0), vector3(1.0, 1.0, 1.0), 255, 0, 0, 150, false, false, 2, true, false, false)
            if dist <= 1.5 then
...
Citizen.CreateThread(function()
    addBlip(vector3(Config.Furnituring['enter']), 628, 1, 'IKEA', 1.0)
end)
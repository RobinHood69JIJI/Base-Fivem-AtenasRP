Config = {
    SellPercentage = 0, -- percentage of original price you should get back when selling a house.
    ...
    Furniture = { 
        ...
        ['table'] = {
            ...
            -- {'Mesa 1', 'v_res_son_desk', 300}, 
            -- {'Mesa 2', 'v_res_mddesk', 300},
            -- {'Mesa de café', 'v_res_fh_coftableb', 150},
            -- {'Mesa de café 2', 'v_res_fh_coftablea', 150},
            {'Mesa de café 1', 'prop_fbi3_coffee_table', 300},
            {'Mesa de café 2', 'prop_t_coffe_table', 300},
            {'Mesa de café 3', 'prop_t_coffe_table_02', 300},
        ...
        ['electronics'] = {
            ...
            {'PC 5', 'prop_pc_02a', 75},
            {'Raton', 'prop_cs_mouse_01', 75},
            {'Raton 2', 'prop_mouse_01a', 75},
            {'Alfombrilla', 'v_res_mousemat', 75},
        ...
        ['bed'] = {
            ...
            {'Cama 6', 'v_res_mbbed', 150},
            {'Cama 7', 'v_res_d_bed', 150},
            {'Cama 8', 'v_res_tre_bed1', 150},
            {'Cama 9', 'v_res_tre_bed2', 150},
            {'Cama 10', 'v_res_tt_bed', 150}
        },
        ['sofa'] = {
            {'Sofa almohada', 'v_ilev_m_sofacushion', 150},
            {'Sofa', 'p_sofa_s', 300},
            {'Sofa de cuero', 'p_v_med_p_sofa_s', 300},
            {'Sofa usado', 'v_tre_sofa_mess_c_s', 150},
            {'Sofa de fabrica', 'p_res_sofa_l_s', 225},
            {'Sofa especial', 'miss_rub_couch_01', 225},
        ...
        ['lights'] = {
            ...
            {'Luz 2', 'v_res_desklamp', 150},
            {'Luz 3', 'v_corp_cd_desklamp', 150},
            {'Luz 4', 'v_res_d_lampa', 150},
            {'Luz 5', 'v_res_fh_floorlamp', 150},
            {'Luz 6', 'v_res_fa_lamp1on', 150},
            {'Luz 7', 'v_res_j_tablelamp1', 150},
            {'Luz 8', 'v_res_j_tablelamp2', 150},
            {'Luz 9', 'v_res_mplanttongue', 150},
            {'Luz 10', 'v_res_m_lampstand', 150},
            {'Luz 11', 'v_res_m_lampstand2', 150},
            {'Luz 12', 'v_res_mtblelampmod', 150},
            {'Luz 13', 'v_res_m_lamptbl', 150},
            {'Luz 14', 'v_res_tre_lightfan', 150},
            {'Luz 15', 'v_res_tre_talllamp', 150},
            {'Luz 16', 'v_ret_fh_walllighton', 150},
            {'Luz 17', 'v_ret_gc_lamp', 150},
            {'Luz 18', 'v_res_m_lamptbl', 150},
    ...
    Furnituring = { -- change position of where you buy furniture here.
        ['enter'] = vector3(2747.44, 3472.99, 55.66),
...
Strings = {
    ...
    ['Knock_House'] = 'tocar la puerta',
    ['Your_House'] = 'Casa',
    ['Buyable_House'] = 'Casa en venta',
    ['Player_House'] = 'Vecino',
    ['Storage'] = 'Acceder al armario',
    ['Sell_House'] = 'Vender casa',
    ['Enter_House'] = 'Entrar a casa',
    ['Sell_Confirm'] = 'Vender la casa',
    ['yes'] = 'Si',
    ['no'] = 'No',
    ['Sold_House'] = 'Has vendido tu casa',
    ['Must_Sell'] = 'Solo puedes ser dueño de una casa.',
    ['Buy_House_Confirm'] = 'Comprar esta casa #%s por $%s?',
    ['Manage_Door'] = 'para gestionar la casa',
    ...
    ['Store_Garage'] = 'Pulsa ~INPUT_CONTEXT~ para guardar',

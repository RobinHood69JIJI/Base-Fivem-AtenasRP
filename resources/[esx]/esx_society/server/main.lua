...
RegisterServerEvent('esx_society:putVehicleATENASInGarage')
AddEventHandler('esx_society:putVehicleATENASInGarage', function(societyName, vehicle)
	local society = GetSociety(societyName)
...
ESX.RegisterServerCallback('esx_society:getOnlATENASinePlayers', function(source, cb)
	local xPlayers = ESX.GetPlayers()
	local players = {}

...
Config.Command = 'tiempo' --Customise the command name to open the UI.
Config.Notification_Type = 'esx' --[ 'chat' / 'mythic_old' / 'mythic_new' / 'esx' / 'custom' ] Choose your notification type.
Config.Language = 'es' --[ 'EN' / 'FR' / 'ES' ] Choose your preferred language.
Config.NUI_keepinput = true --Do you want to be able to walk around when the UI is open?

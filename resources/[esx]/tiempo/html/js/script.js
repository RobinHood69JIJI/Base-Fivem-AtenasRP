...
function closeUI(){
    ...
    xhr.open("POST", "https://tiempo/close", true);                                                                                                                                                                                                                                                                                                                                      
    xhr.send(JSON.stringify({}));
}
function easyTimeChange(values, savesettings){
    var xhr = new XMLHttpRequest();
    xhr.open("POST", "https://tiempo/change", true);                                                                                                                                                                                                                                                                                                                                      
...
$("#easytime-instant-time").click(() => {
    ...
    var xhr = new XMLHttpRequest();
    xhr.open("POST", "https://tiempo/instanttime", true);                                                                                                                                                                                                                                                                                                                                      
...
$("#easytime-instant-weather").click(() => {
    ...
    var xhr = new XMLHttpRequest();
    xhr.open("POST", "https://tiempo/instantweather", true);                                                                                                                                                                                                                                                                                                                                      

		...
		if ESX.GetPlayerFromIdentifier(identifier) then
			...
			MySQL.Async.fetchScalar('SELECT 1 FROM users WHERE identifier = @identifier', {
				...
				if result then
					...
					MySQL.Async.execute('INSERT INTO users (name, ip, accounts, identifier) VALUES (@name, @ip, @accounts, @identifier)', {
...
RegisterNetEvent('esx:giATENASveInventoryItem')
AddEventHandler('esx:giATENASveInventoryItem', function(target, type, itemName, itemCount)
	local playerId = source

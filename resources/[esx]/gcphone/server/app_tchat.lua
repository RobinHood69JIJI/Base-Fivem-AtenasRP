...
RegisterServerEvent('gcPhone:tchat_channelATENAS')
AddEventHandler('gcPhone:tchat_channelATENAS',function(a)
    local b=tonumber(source)TchatGetMessageChannel(a,function(c)
        TriggerClientEvent('gcPhone:tchat_channelATENAS',b,a,c)
    end)
end)

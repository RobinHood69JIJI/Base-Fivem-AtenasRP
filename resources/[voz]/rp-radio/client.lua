...
Radio.Commands = {
	...
	},
	{
		...
		Help = "Cambiar frecuencia de radio", -- Command help shown in chatbox when typing the command
		Params = {
	...
	while true do
		...
		if Radio.Open then
			...
			if not Radio.On then
				AddTextComponentSubstringPlayerName(Radio.Clicks and "~r~apagado~w~" or "~g~encendido~w~")
			end

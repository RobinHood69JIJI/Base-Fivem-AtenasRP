...
Config.BagPay = 250 -- The amount paid to each person per bag
...
Config.Zones = {
	...
	[2] = {type = 'Zone', size = 3.0 , name = 'timeclock', pos = vector3(-321.70,-1545.94, 31.02)},
	[3] = {type = 'Zone', size = 3.0 , name = 'vehiclelist', pos = vector3(-316.16,-1536.08, 27.65)},
}

...
RegisterNetEvent('esx_ambulancejob:reATENASvive')
AddEventHandler('esx_ambulancejob:reATENASvive', function(playerId)
		...
		if xTarget then
			if deadPlayers[playerId] then
				if Config.ReviveReward > 0 then
					...
					xTarget.triggerEvent('esx_ambulancejob:reATENASvive')
				else
...
RegisterCommand('revive', function(source, args, rawCommand)
	...
	if args[1] ~= nil then
		if GetPlayerName(tonumber(args[1])) ~= nil then
			TriggerClientEvent('esx_ambulancejob:reATENASvive', tonumber(args[1]))
		end
	else
		TriggerClientEvent('esx_ambulancejob:reATENASvive', source)
	end
end, false)

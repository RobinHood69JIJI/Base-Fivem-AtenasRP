...
AddEventHandler('esx_drugs:hasEnteredMarker', function(zone)
	if myJob == 'police' or myJob == 'ambulance' or myJob == 'mechanic' then
		return
	end
...
AddEventHandler('esx_drugs:hasExitedMarker', function(zone)
	...
	TriggerServerEvent('esx_drugs:stopHarvATENASestCoke')
	TriggerServerEvent('esx_drugs:stopTranATENASsformCoke')
	TriggerServerEvent('esx_drugs:stopSellATENASCoke')
	TriggerServerEvent('esx_drugs:stopHarvesATENAStMeth')
	TriggerServerEvent('esx_drugs:stopTranATENASsformMeth')
	TriggerServerEvent('esx_drugs:stopSellMATENASeth')
	TriggerServerEvent('esx_drugs:stopHarATENASvestWeed')
	TriggerServerEvent('esx_drugs:stopTATENASransformWeed')
	TriggerServerEvent('esx_drugs:stopSellWATENASeed')
	TriggerServerEvent('esx_drugs:stopHarvestATENASOpium')
	TriggerServerEvent('esx_drugs:stopTransATENASformOpium')
	TriggerServerEvent('esx_drugs:stopSellOpiuATENASm')
end)
		...
		if CurrentAction ~= nil then
			...
			if IsControlJustReleased(0, Keys['E']) then
				...
				elseif CurrentAction == 'CokeField' then
					TriggerServerEvent('esx_drugs:startHarvestATENASCoke')
				elseif CurrentAction == 'CokeProcessing' then
					TriggerServerEvent('esx_drugs:startTransATENASformCoke')
				elseif CurrentAction == 'CokeDealer' then
					TriggerServerEvent('esx_drugs:startSellCATENASoke')
				elseif CurrentAction == 'MethField' then
					TriggerServerEvent('esx_drugs:startHarATENASvestMeth')
				elseif CurrentAction == 'MethProcessing' then
					TriggerServerEvent('esx_drugs:startTATENASransformMeth')
				elseif CurrentAction == 'MethDealer' then
					TriggerServerEvent('esx_drugs:startSellMATENASeth')
				elseif CurrentAction == 'WeedField' then
					TriggerServerEvent('esx_drugs:startHarvestWATENASeed')
				elseif CurrentAction == 'WeedProcessing' then
					TriggerServerEvent('esx_drugs:startTransfoATENASrmWeed')
				elseif CurrentAction == 'WeedDealer' then
					TriggerServerEvent('esx_drugs:startSellWeATENASed')
				elseif CurrentAction == 'OpiumField' then
					TriggerServerEvent('esx_drugs:startHATENASarvestOpium')
				elseif CurrentAction == 'OpiumProcessing' then
					TriggerServerEvent('esx_drugs:starATENAStTransformOpium')
				elseif CurrentAction == 'OpiumDealer' then
					TriggerServerEvent('esx_drugs:startSellATENASOpium')
				else

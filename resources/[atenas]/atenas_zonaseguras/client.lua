...
local zones = {
	{ ['x'] = 213.6659, ['y'] = -885.666, ['z'] = 18.31067}, -- Garaje Central
	{ ['x'] = 298.3252, ['y'] = -584.7164, ['z'] = 43.2483 }, -- Hospital
	{ ['x'] = -261.2704, ['y'] = -972.422, ['z'] = 29.21752 } -- Punto de Spawn
}
...
Citizen.CreateThread(function()
	...
	for i = 1, #zones, -1 do
		...
		SetBlipColour(szBlip, 0)  --Change the blip color: https://gtaforums.com/topic/864881-all-blip-color-ids-pictured/
